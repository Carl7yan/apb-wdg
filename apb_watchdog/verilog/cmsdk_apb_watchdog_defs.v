...
// Watchdog base address prefixes       基址前缀
...
`define ARM_WDOGLOADA 3'b000   //装载寄存器： WDOGLOAD ，其作用是设置计数器初始值
`define ARM_WDOGVALUEA 3'b001   //数值寄存器：WDOGVALUE   查看计数器当前值

`define ARM_WDOGCONTROLA 3'b010  //控制寄存器，其作用是能够让软件控制看门狗模块
`define ARM_WDOGCLEARA 3'b011
`define ARM_WDOGINTRAWA 3'b100
`define ARM_WDOGINTA 3'b101

// Watchdog Lock register
`define ARM_WDOGLOCKA 3'b000       //锁定寄存器
